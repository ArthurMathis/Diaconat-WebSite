<nav class="nav-barre" id="barre-de-navigation">
    <h1>Ypopsi</h1>
    <div>
        <a class="LignesHover" href="index.php"><img  src="layouts\assets\img\logo\home.svg" alt="Logo de la page d'accueil, représenté par une maison"></a>
...
<section id="menu">
    <main>
        <header>
            <h1>Ypopsi</h1>
            <div id="bouton-close-menu" class="LignesHover"><img src="layouts\assets\img\logo\close.svg" alt="Logo de fermeture du menu, représenté par une croix"></div>
        </header>
        <content>
